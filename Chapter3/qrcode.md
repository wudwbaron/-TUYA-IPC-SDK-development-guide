...
* 在__tuya_linux_get_snap_qrcode中实现识别app上二维码的动作（[zbar库的使用](https://wudwbaron.github.io/TUYA-IPC-SDK-development-guide/Chapter3/zbar.html)），并返回识别的信息给tuya_ipc_direct_connect这个函数（很重要）  
